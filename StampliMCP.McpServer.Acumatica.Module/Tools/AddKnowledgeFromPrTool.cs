...
This tool:
1. Checks for duplicates via erp__query_knowledge (erp=""acumatica"")
...
Call erp__query_knowledge(erp=""acumatica"", query=""<key terms>"", scope=""all"") to check for duplicates.
...
WARNING: DO NOT rebuild MCP server (it would kill the parent process). User will rebuild manually after this tool completes.
