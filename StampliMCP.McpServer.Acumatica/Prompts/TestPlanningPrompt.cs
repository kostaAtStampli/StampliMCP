        ...
        string operationName)
    {
        return new[]
        {
            ...
            new ChatMessage(ChatRole.User, $"""
                ...
                **Available MCP Tools**:
                - `generate_test_scenarios` - Get AI-powered test scenario generation
                - `get_operation_details` - Get operation specs (fields, validation rules, errors)
                - `get_error_catalog` - Access all known errors for this operation
            ...
            new ChatMessage(ChatRole.Assistant, $"""
                ...
                **Test Design Strategy**:
                1. First, I'll use `get_operation_details` to understand all fields and validation rules
                2. Then check `get_error_catalog` to find every possible error
                3. Use `generate_test_scenarios` to get AI-powered scenario generation
