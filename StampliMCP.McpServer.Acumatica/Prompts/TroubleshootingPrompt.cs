        ...
        string errorMessage)
    {
        return new[]
        {
            ...
            new ChatMessage(ChatRole.User, $"""
                ...
                **Available MCP Tools**:
                - `troubleshoot_error` - Get AI-powered root cause analysis
                - `get_error_catalog` - Access complete error catalog with all known errors
                - `get_operation_details` - Get operation specs to understand validation rules
                - `search_operations` - Find which operation is triggering this error
            ...
            new ChatMessage(ChatRole.Assistant, $"""
                ...
                **Debugging Strategy**:
                1. First, I'll use `troubleshoot_error` to get detailed root cause analysis
                2. Then check `get_error_catalog` to find all related errors
                3. Query `get_operation_details` to understand the validation context
                4. Provide you with:
